...
const socialLinks: SocialLink[] = copy.socials.map((s) => ({
  title: s.title,
  href: s.href,
  icon: socialIcons[s.key] ?? null,
}));

const workExperienceItems = copy.workExperience.map((w) => ({
  ...w,
  startDate: new Date(w.startDate),
  endDate: w.endDate ? new Date(w.endDate) : undefined,
}));

const educationItems = copy.education.map((e) => ({
  ...e,
  ...
  return (
    <>
      <Header
        ...
        fullName={copy.brand.name}
        currentRole={copy.brand.role}
