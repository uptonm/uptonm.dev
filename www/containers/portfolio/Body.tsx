...
export const Body = () => {
	...
	const bodyData = {
		bio: `Hi! I'm Mike. I am a Boston based Software Engineer currently working at Infogain
		as a contractor for Facebook. My interests in software are majorly in the web space, including 
		React, TypeScript, Golang, and more recently Elixir. In the little free time that I have I 
		enjoy snowboarding, and drinking expensive coffee.`,
		workExperience: [
			{
	...
	const skills = ["React", "Vue", "TypeScript", "Node.js", "Jest", "Cypress", "Golang", "PostgreSQL", "Docker", "Nginx", "APIs and MicroServices"]
										...
										<li key={skill} className="inline">
											...
											>
												<div className="absolute flex-shrink-0 flex items-center justify-center">
													<span
														style={{ backgroundColor: StringToHslColor(skill, theme === "dark" ? 75 : 60,  50 ) }}
														className="h-2 w-2 rounded-full"
														aria-hidden="true"
													/>
												</div>
												<div className="ml-3.5 text-sm font-medium text-gray-900 dark:text-gray-300">{skill}</div>
											</a>&nbsp;
										</li>
									))}
								</ul>
